<?php
//Chỉnh lại để theo database hotel nha, này là code cho cái database mẫu,
//2 file php kia cũng còn đang theo mẫu, sửa lại theo db này là được
//get input value
$type = $_POST["showType"];
...
if($type == 'all') {
	...
	// output 3 table
	echo "Search For All Tables <br>";
	echo "Here is your data you looking for.<br>";
